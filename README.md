...
**Version 1.5.5.** The plugin is installable on desktop and mobile (`isDesktopOnly: false`), uses no Node/Electron APIs at runtime, and bundles its assets. Actual device testing is documented in [the test report](docs/TEST-REPORT.md); mobile-capable does not mean Android-verified.

![Read documents directly on the Roseboard canvas](docs/roseboard-canvas-reader.png)

**[Download 1.5.5](https://github.com/ranKirito/obsidian-roseboard/releases/tag/1.5.5)** · **[Report a bug or suggest an improvement](https://github.com/ranKirito/obsidian-roseboard/issues/new/choose)**

Version 1.5.5 is the supported downloadable release. All development work is consolidated on `main`; older development remains in Git history. The [Obsidian Community Directory listing](https://community.obsidian.md/plugins/roseboard) is live: choose **Add to Obsidian**, then install and enable Roseboard. Manual installation is available below.

## What is new in 1.5.5

- Descriptions stay visible at all zoom levels in a fixed, non-scrolling four-line preview. **Show more** expands the full text; **Show less** collapses it. Checklists start closed and only open when you choose.

## What is new in 1.5.4

- Fixed the black-board crash caused by repeated layout updates on existing boards with wrapped checklist text.

## What is new in 1.5.3

- Task descriptions reserve readable space and scroll without fading. Small cards grow in the view, and resizing respects the space needed for the description and first three wrapped checklist rows.
- Checklist steps have more room, **Add step** stays outside the scrolling list, and long step editors wrap as you type. **Show more** expands the checklist without rewriting the saved card size.
...
1. Download **[roseboard-1.5.5.zip](https://github.com/ranKirito/obsidian-roseboard/releases/download/1.5.5/roseboard-1.5.5.zip)**. Start with a test vault; back up your existing plugin folder before upgrading a vault you use daily.
